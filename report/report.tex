...
\section{Results}
  ...
  \begin{figure*}[p]
    \begin{center}
      \begin{tabular}{lr}
        \includegraphics[width=8cm]{figures/simulation-40-alpha5.pdf} &
        \includegraphics[width=8cm]{figures/simulation-40-alpha5.pdf} \\
        \includegraphics[width=8cm]{figures/simulation-40-alpha10.pdf} &
        \includegraphics[width=8cm]{figures/simulation-40-alpha10.pdf} \\
        \includegraphics[width=8cm]{figures/simulation-40-alpha15.pdf} &
        \includegraphics[width=8cm]{figures/simulation-40-alpha15.pdf}
      \end{tabular}
      \caption{Results of realistic simulations (left) and TODO macroscopic model (right) for $\alpha = 5$, $10$ and $15$ (from top to bottom)}
    \end{center}
  \end{figure*}
